...
const STATIC_ROUTES = [
  ...
  ["/plank-and-beam", "0.8"],
  // Subcategory pages with their own SEO (self-canonical, distinct titles +
  // buying-guide copy) — surfaced so Google can discover and rank each term.
  ["/category/loft-beds?subcategory=low-loft", "0.7"],
  ["/category/loft-beds?subcategory=mid-loft", "0.7"],
  ["/category/loft-beds?subcategory=high-loft", "0.7"],
  ["/category/loft-beds?subcategory=loft-with-desk", "0.7"],
  ["/category/bunk-beds?subcategory=low-bunk", "0.7"],
  ["/category/dining?subcategory=dining-tables", "0.7"],
  ["/category/dining?subcategory=dining-chairs", "0.7"],
  ["/category/dining?subcategory=dining-benches", "0.7"],
  ["/category/dining?subcategory=bar-counter-chairs", "0.7"],
  ["/category/dining?subcategory=dining-sets", "0.7"],
  ["/category/living?subcategory=coffee-tables", "0.7"],
  ["/category/living?subcategory=console-tables", "0.7"],
  ["/category/living?subcategory=side-tables", "0.7"],
  ["/category/living?subcategory=sideboards", "0.7"],
  ["/category/living?subcategory=tv-stands", "0.7"],
  ["/category/living?subcategory=shelves", "0.7"],
  ["/category/living?subcategory=entryway", "0.7"],
  ["/smart-deals", "0.8"],
  ["/about", "0.6"],
  ["/contact", "0.6"],
  ["/faqs", "0.6"],
